...
class bertModel(nn.Layer):
    ...
    def __init__(self, d_model, nhead, n_layer, vocab_size, max_len, hidden_size):
        ...
        self.encoder_layer = TransformerEncoderLayer(d_model = d_model,
                                        nhead = nhead, dim_feedforward = hidden_size)
        self.encoder = TransformerEncoder(self.encoder_layer, num_layers = n_layer)
